...
farbe_stadt_einzelnd <- "#FFA6A6"
farbe_stadt_andere   <- "#FFD9D9"
...
dichte_df %>%
  ...
  labs(x = "Zimmermiete in €", y = NULL, title = "Hamburg im deutschlandweiten Vergleich") +
  theme(legend.position = "none", 
        plot.title = element_text(family = "franklin", hjust = 0.5, size = 18,
...
file_save <- "C:\\Users\\hellm\\Desktop\\WG-Gesucht_Analyse\\abbildungen\\projekte\\broschueren\\präsentation_politik_hamburg\\Ridgeline_vergleich_Hamburg.png"
