...
filter_profile <- tribble(
  ...
  "M, 19J, 440€",        c("Geschlecht egal", "Mann"), 19,            440,           T,
  "F, 19J, 440€",        c("Geschlecht egal", "Frau"), 19,            440,           T
)
...
file_save <- "/home/fabian/Schreibtisch/WG-Gesucht_Analyse/abbildungen/projekte/vorträge/2026_hamburg_dielinke/GesMiete_Hamburg_4.png"
