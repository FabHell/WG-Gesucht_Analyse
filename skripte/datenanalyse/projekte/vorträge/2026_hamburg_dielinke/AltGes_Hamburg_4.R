...
Plot_geschlecht <- Daten_Staedte_geschlecht %>%  
  ...
  with_outer_glow(
    geom_col(data = Daten_Staedte_geschlecht %>% 
               filter(geschlecht_ges %in% c("Geschlecht egal", "Frau", "Mann")),
...
file_save <- "/home/fabian/Schreibtisch/WG-Gesucht_Analyse/abbildungen/projekte/vorträge/2026_hamburg_dielinke/AltGes_Hamburg_4.png"
