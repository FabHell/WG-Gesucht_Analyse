...
Karte_Hexagon <- ggplot() + 
  ...
  scale_fill_gradient(
    low   = panel_background_color, 
    high = panel_background_color,
    na.value = panel_background_color,
...
file_save <- "/home/fabian/Schreibtisch/WG-Gesucht_Analyse/abbildungen/projekte/vorträge/2026_hamburg_dielinke/Karte_WGs_Hamburg_0.png"
