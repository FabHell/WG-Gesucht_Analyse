...
filter_profile <- tribble(
  ...
  "M, 19J, 500€",        c("Geschlecht egal", "Mann"), 19,            500,           F,
  "F, 19J, 500€",        c("Geschlecht egal", "Frau"), 19,            500,           F,
  "M, 19J, 440€",        c("Geschlecht egal", "Mann"), 19,            440,           F,
  "F, 19J, 440€",        c("Geschlecht egal", "Frau"), 19,            440,           F,
  "M, 25J, 440€",        c("Geschlecht egal", "Mann"), 25,            440,           T,
  "F, 25J, 440€",        c("Geschlecht egal", "Frau"), 25,            440,           T
)
...
file_save <- "/home/fabian/Schreibtisch/WG-Gesucht_Analyse/abbildungen/projekte/vorträge/2026_hamburg_dielinke/GesMiete_Hamburg_5.png"
