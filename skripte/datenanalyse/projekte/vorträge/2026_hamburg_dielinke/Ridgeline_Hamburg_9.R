...
label_df <- tribble(
  ...
  grenzwert_1-62.5, Inf,  1,      farbe_unter, "Angebote unter\naktueller Pauschale",
  (grenzwert_1+grenzwert_2)/2, Inf,  0.5,      "#7A6E65" , "Angebote im\nAnpassungsbereich",
  grenzwert_2+62.5, Inf,  0,      farbe_ueber, "Angebote über\nkünftiger Pauschale"
)
...
file_save <- "/home/fabian/Schreibtisch/WG-Gesucht_Analyse/abbildungen/projekte/vorträge/2026_hamburg_dielinke/Ridgeline_Hamburg_9.png"
