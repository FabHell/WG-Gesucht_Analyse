...
img <- readPNG(glue("/home/fabian/Schreibtisch/WG-Gesucht_Analyse/daten/wappen/{stadt}_wappen.png"))
...
file_save <- "/home/fabian/Schreibtisch/WG-Gesucht_Analyse/abbildungen/projekte/vorträge/2026_hamburg_dielinke/1_Titelblatt_Sunburst.png"
