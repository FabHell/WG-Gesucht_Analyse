...
label_df <- tribble(
  ...
  grenzwert_1-62.5, Inf,  1,      farbe_unter, "Inserate unter aktueller Pauschale",
  (grenzwert_1+grenzwert_2)/2, Inf,  0.5,      "#7A6E65" , "Inserate im Anpassungsbereich",
  grenzwert_2+62.5, Inf,  0,      farbe_ueber, "Inserate über geplanter Pauschale"
)
...
file_save <- "Abbildungen/1_Präsentation_Linke_Kassel/Ridgeline_Kassel_10.png"
