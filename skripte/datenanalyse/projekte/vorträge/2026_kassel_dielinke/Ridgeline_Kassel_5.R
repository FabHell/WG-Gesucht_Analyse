...
label_df <- tribble(
  ...
  grenzwert_1+7.5, Inf,  0,      farbe_ueber, "Inserate über aktueller Pauschale"
)
...
file_save <- "Abbildungen/1_Präsentation_Linke_Kassel/Ridgeline_Kassel_5.png"
