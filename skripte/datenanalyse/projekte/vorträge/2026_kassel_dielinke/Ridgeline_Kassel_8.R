...
label_df <- tribble(
  ...
  grenzwert_2+7.5, Inf,  0,      farbe_ueber, "Inserate über geplanter Pauschale"
)
...
file_save <- "Abbildungen/1_Präsentation_Linke_Kassel/Ridgeline_Kassel_8.png"
