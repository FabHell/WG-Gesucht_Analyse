...
label_df <- tribble(
  ...
  grenzwert_1-7.5, Inf,  1,      farbe_unter, "Inserate unter aktueller Pauschale"
  )
...
Abb_Dichte <- ggplot(dichte_df, aes(x = x, y = y, fill = bereich)) +
  ...
  geom_vline(xintercept = grenzwert_2, linetype = "solid", 
...
file_save <- "Abbildungen/1_Präsentation_Linke_Kassel/Ridgeline_Kassel_7.png"
