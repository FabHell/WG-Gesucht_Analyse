...
Plot_geschlecht <- Daten_Staedte_geschlecht %>%  
  ...
  theme(
    ...
    axis.text.x = element_text(color = background_color, family = axis_text_family,
                               margin = margin(t=7.5)),
    axis.title.x = element_text(color = background_color, family = axis_title_family,
                                margin = margin(t=7.5))  
  )
...
Plot_waffle_w <- Daten_waffle_w %>%
  ...
  scale_fill_manual(
    values = c("zielgruppe" = background_color, "andere" = background_color)
  ) +
  labs(
  ...
  theme(
    ...
    plot.title = element_text(family = "domine", margin = margin(b=-17.5), size = 12,
                              vjust = 0, color = background_color),
    plot.subtitle = element_text(family = "domine", size = 22, hjust = 1, 
                                 face = "bold", background_color),
...
file_save <- "Abbildungen/1_Präsentation_Linke_Kassel/Ersties_kassel_1.png"
